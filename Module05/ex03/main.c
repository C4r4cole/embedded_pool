...
/*   Updated: 2026/04/24 15:15:56 by fmoulin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	while (1)
	{
		...
		// on considere que 1 unite ADC vaut plus ou moins 1 degre
		// on considere aussi que si la puce ne fait presque rien
			// sa temperature est plus ou moins egale a la temperature ambiante
		temp = result - 348;
		uart_printstr(itoa(temp, buf, 10));
		uart_printstr("\r\n");
